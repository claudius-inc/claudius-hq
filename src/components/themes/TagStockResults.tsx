        ...
        <table className="min-w-full">
          <thead>
            <tr className="text-xs text-gray-500 border-b border-gray-100">
              ...
              <th className="px-4 py-2.5 text-left font-medium uppercase hidden sm:table-cell">Name</th>
              <th className="px-4 py-2.5 text-right font-medium uppercase">Price</th>
            ...
            {stocks && stocks.length > 0 ? stocks.map((stock) => (
              <tr key={stock.ticker} className="hover:bg-gray-50">
                ...
                <td className="px-4 py-2.5 hidden sm:table-cell">
                  <span className="text-xs text-gray-500 truncate max-w-[160px] block">{stock.name}</span>
                </td>
