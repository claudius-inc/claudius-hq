...
const Q1_2026: ThirteenFFacts = {
  ...
  topBought: {
    ...
    value: [
      ...
      {
        // Held by none of the 26 last quarter and five of them now — the only
        // consensus in either list that was built from nothing this quarter.
        ticker: "AZN",
        name: "AstraZeneca",
        netUsd: 919_000_000,
        buyers: 5,
