...
const QUADRANTS: Record<string, GavekalQuadrant> = {
  "1,1": {
    ...
    buySignals: [
      "Growth equities (QQQ, VUG, S&P 500)",
      "Long-duration bonds (TLT, EDV)",
  ...
  "-1,1": {
    ...
    buySignals: [
      "Government bonds (TLT, IEF, SGOV)",
      "Cash (MAS T-bills SGD, SGOV USD)",
      "Defensive equities (XLP, XLU, USMV)",
    ],
