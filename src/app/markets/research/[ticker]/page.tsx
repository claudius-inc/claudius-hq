        ...
        <div className="max-w-6xl mx-auto px-4 py-2 md:py-3">
          ...
          <div className="flex items-center justify-between gap-2 text-sm mb-1">
            <div className="flex items-center gap-2 text-gray-400">
              <Link href="/markets/research" className="hover:text-gray-600 transition-colors">Research</Link>
              <span>›</span>
              <span className="text-gray-900 font-medium">{decodedTicker}</span>
            </div>
            {report && (
              <ReportActions
                olderReports={olderReports as { id: number; ticker: string; title: string; created_at: string }[]}
            ...
            <div className="flex-1 min-w-0">
              ...
              {olderReports.length > 0 && (
                <div className="px-4 lg:px-0 mt-6">
                  <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Previous Reports</h2>
                  <ul className="space-y-1">
                    {olderReports.map((r) => {
                      const olderReport = r as unknown as { id: number; ticker: string; title: string; created_at: string };
                      return (
                        <li key={olderReport.id}>
                          ...
                          >
                            ...
                            Report from {formatShortDate(olderReport.created_at)}
                          </Link>
                        </li>
                      );
                    })}
