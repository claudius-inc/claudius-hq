...
export function AddTickerModal({ open, onClose }: AddTickerModalProps) {
  ...
  // The profile is generated by Gemini in the same call as tags/themes/desc
  // and persisted on submit. Not surfaced in the form UI — too many fields
  // for the compact add modal — but the user can review / edit it on the
  // ticker page after the row is created.
