...
**API KEY:** Read HQ_API_KEY from /root/openclaw/claudius-inc/claudius-hq/.env.local (line starting with HQ_API_KEY=)

**EXECUTION STEPS:**
1. Mark job as processing:
   curl -X PATCH 'https://www.claudiusinc.com/api/stocks/research/${jobId}' -H 'x-api-key: <HQ_API_KEY>' -H 'Content-Type: application/json' -d '{"status":"processing","progress":10}'
...
4. POST the complete report:
   curl -X POST 'https://www.claudiusinc.com/api/stocks/reports' -H 'x-api-key: <HQ_API_KEY>' -H 'Content-Type: application/json' -d '{"ticker":"${cleanTicker}","title":"...","content":"<FULL REPORT>","report_type":"sun-tzu"}'

5. Complete the job with report_id:
   curl -X PATCH 'https://www.claudiusinc.com/api/stocks/research/${jobId}' -H 'x-api-key: <HQ_API_KEY>' -H 'Content-Type: application/json' -d '{"status":"complete","progress":100,"report_id":REPORT_ID}'
